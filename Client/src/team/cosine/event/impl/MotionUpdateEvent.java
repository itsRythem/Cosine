...
public final class MotionUpdateEvent extends Event {
	...
	public MotionUpdateEvent(final double posX, final double posY, final double posZ, final double prevPosX, final double prevPosY, final double prevPosZ, final float rotationYaw, final float rotationPitch, final float prevRotationYaw, final float prevRotationPitch, final boolean onGround, final byte type)
	{
		this.posX = posX;
		this.posY = posY;
		this.posZ = posZ;
